...
class D(_coconut.collections.namedtuple("D", "gene J_gene V_gene"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
class Comb(_coconut.collections.namedtuple("Comb", "gene length"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
class DGene(_coconut.collections.namedtuple("DGene", "read gene"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
class DRead(_coconut.collections.namedtuple("DRead", "read J_gene V_gene"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
class DIndexRead(_coconut.collections.namedtuple("DIndexRead", "read J_gene V_gene dataset"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
class Kmer(_coconut.collections.namedtuple("Kmer", "kmer read"), _coconut.object):
    __slots__ = ()
    __ne__ = _coconut.object.__ne__
